...
import 'package:flutter_driver/main.dart';
...
class _MapsState extends State<Maps>
  ...
  void initState() {
    ...
    FlutterOverlayWindow.closeOverlay(); // replaces DashBubble.instance.stopBubble();
                                                                      ...
                                                                      if (((userDetails['vehicle_type_id'] != null) ||
                                                                        ...
                                                                        if (userDetails['active'] ==
                                                                          ...
                                                                          if (pref.getBool('isOverlaypermission') != false &&
                                                                            ...
                                                                            if (/*await DashBubble.instance.hasOverlayPermission()*/ await FlutterOverlayWindow.isPermissionGranted()
                                                                                ==
                                                                                false) {
                                                                              setState(() {
